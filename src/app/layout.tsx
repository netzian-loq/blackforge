...
export const metadata: Metadata = {
  ...
  title: {
    default: `${site.name} — Asphalt Repair, Paving & Sealcoating in Middle Tennessee`,
    template: `%s — ${site.name}`,
  },
  description: site.description,
  applicationName: site.name,
  keywords: [
    "asphalt repair Middle Tennessee",
    "asphalt paving Nashville",
    "pothole repair Nashville TN",
    "sealcoating Middle Tennessee",
    "driveway paving Franklin TN",
    "parking lot repair Murfreesboro",
    "commercial asphalt contractor Nashville",
  ],
  ...
  openGraph: {
    ...
    url: site.url,
    siteName: site.name,
    title: `${site.name} — Asphalt Repair & Paving in Middle Tennessee`,
    description: site.description,
  },
  twitter: {
